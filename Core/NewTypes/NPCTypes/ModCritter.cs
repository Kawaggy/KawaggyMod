...
namespace KawaggyMod.Core.NewTypes.NPCTypes
{
    public abstract class ModCritter : KNPC
    {
        ...
        public ModCritter(int maxLife, Vector2 size, float npcSlots, int aiStyle, int aiType, int critterItem, int stack)
        {
            MaxLife = maxLife;
            Size = size;
            NPCSlots = npcSlots;
